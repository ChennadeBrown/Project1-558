...
The following contingency table reports the number of confirmed case statuses  for South Africa and Mexico for a certain time frame since day 1. 
```{r, echo = TRUE}
tbl2 <- table(Day1$Status, Day1$Country)
tbl2
```

The following bar graph reports the number of confirmed case statuses for South Africa and Mexico for a certain time frame since day one which were similar.  
```{r, echo = TRUE}
