...
This function allows the user to return NewDeaths, TotalDeaths, & NewRecovered, or all columns from the Summary API.  To subset by rows the user can enter arguments in the filter function.
```{r, echo = TRUE, message = FALSE, results = 'hide'}
