...
The following code returns numerical summaries for total deaths among all countries reported in the Summary API.  The average total deaths was approximately 24K.
```{r, echo = TRUE}
resp2Df %>%
